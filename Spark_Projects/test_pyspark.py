...
# separated fields.
#mnm_df = spark.read.format("csv").option("header", "true").option("inferSchema", "true")
mnm_df = spark.read.csv("/Users/bilalmohammed 1/Desktop/mnm_dataset.csv").\
    withColumnRenamed("_c0", "State").\
    withColumnRenamed("_c1","Color").\
